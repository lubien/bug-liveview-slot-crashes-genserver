defmodule BugSlotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BugSlotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BugSlotWeb.Gettext, "errors", msg, opts)
    end
  end
